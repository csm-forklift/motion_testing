#!/usr/bin/env python
'''
This node dictates which controller can be running at a given time.
'''
...
class ControllerHandler:
    def __init__(self):
        ...
        rospy.init_node("controller_handler")
        ...
        self.controller_pub = rospy.Publisher("/control_mode", Int8, queue_size=3)
